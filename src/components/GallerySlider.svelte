...
<div class="grid-container">
    <main class="grid-item main">
        <div class="items">
        { #each images as img }
            <div class="item rvp-max-height" style="background-image: url('{img.src}');" alt="">
                <div class="rvp-show-image"> 
                    <button on:click="{() => (source = img.src, hide = '')}">View Image</button>
                </div>
            </div>
        {/each}
        </div>
...
<Modal on:close={hideModal} source={source} hide={hide}/>